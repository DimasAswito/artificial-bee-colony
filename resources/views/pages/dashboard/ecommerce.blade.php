  ...
  <div class="grid grid-cols-12 gap-4 md:gap-6">
    ...
    <div class="col-span-12 grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12 xl:col-span-8">
            <div class="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6 h-full flex flex-col w-full min-w-0 overflow-hidden">
        ...
        <div class="col-span-12 xl:col-span-4">
            <div class="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6 h-full flex flex-col w-full min-w-0">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4 shrink-0 text-center">
                    Rasio Mata Kuliah
                </h3>
                <div class="w-full flex justify-center">
                    <div id="chartSemester"></div>
                </div>
            </div>
        </div>
    </div>
