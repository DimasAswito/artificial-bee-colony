...
@section('content')
    ...
    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                ...
                                <select
                                    ...
                                    <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Pilih SKS</option>
                                    <option value="1" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">1</option>
                                    <option value="2" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">2</option>
                                    <option value="3" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">3</option>
                                    <option value="4" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">4</option>
                                    <option value="6" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">6</option>
                                </select>
                                <span class="pointer-events-none absolute top-[calc(50%+14px)] right-4 z-30 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                ...
                                <select
                                    ...
                                    <option value="1" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Dr. Budi Santoso</option>
                                    <option value="2" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Prof. Siti Aminah</option>
                                    <option value="3" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Andi Wijaya, M.Kom</option>
                                    <option value="4" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Rina Kartika, S.Si, M.T</option>
                                </select>
                                <span class="pointer-events-none absolute top-[calc(50%+14px)] right-4 z-30 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                                    <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="lg:col-span-1">
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                    ...
                    <div class="flex items-end justify-between mt-5">
                        <div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Total Mata Kuliah</span>
        ...
        <!-- Card 2: Data Mata Kuliah Table (Basic Table 3 Style) -->
        <div x-data="{
            mkData: [
                {
                    id: 1,
            ...
            dropdownOpen: null,
            get totalPages() {
                return Math.ceil(this.mkData.length / this.itemsPerPage);
            },
            get paginatedData() {
                const start = (this.currentPage - 1) * this.itemsPerPage;
                const end = start + this.itemsPerPage;
                return this.mkData.slice(start, end);
            },
            get displayedPages() {
                const range = [];
                                ...
                                <template x-for="mk in paginatedData" :key="mk.id">
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400" x-text="mk.sks"></div>
                                        </td>
                                        <td class="px-4 py-4 whitespace-nowrap">
