...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <!-- Card 2: Data Dosen Table (Basic Table 3 Style) -->
        <div x-data="{
            dosenData: [
                {
                    id: 1,
            ...
            dropdownOpen: null,
            get totalPages() {
                return Math.ceil(this.dosenData.length / this.itemsPerPage);
            },
            get paginatedData() {
                const start = (this.currentPage - 1) * this.itemsPerPage;
                const end = start + this.itemsPerPage;
                return this.dosenData.slice(start, end);
            },
            get displayedPages() {
                const range = [];
                                    ...
                                    <tr>
                                        <td class="py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900 dark:text-white" x-text="dosen.name"></div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full" :class="getStatusClass(dosen.status)" x-text="dosen.status"></span>
                                        </td>
        ...
        @php
            $history = [
                [
                    'user' => 'Admin (You)',
                    'action' => 'Added New Dosen',
                    'detail' => 'Dr. Budi Santoso',
                    'time' => '2 mins ago',
                    'status' => 'Success',
                ],
                [
                    'user' => 'Admin (You)',
                    'action' => 'Updated Dosen',
                    'detail' => 'Prof. Siti Aminah',
                    'time' => '1 hour ago',
                    'status' => 'Pending',
                ],
                 [
